...
describe('formatDateTime', () => {
  it('should format the date and time correctly', () => {
    const date = new Date('Sat Jan 11 2025 16:04:24 GMT+0000 (Coordinated Universal Time)');
  ...
  it('should handle different date and time', () => {
    const date = new Date('Mon Feb 15 2021 08:30:00 GMT+0000 (Coordinated Universal Time)');
